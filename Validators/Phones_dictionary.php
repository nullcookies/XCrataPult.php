  ...
  '7'=>[
    [
      "default"=>[
        ...
        "code"=>"RU",
        "format"=>[
//          "international_E.123" => "+A B C/4,5",
          "country_wide" => "8 B C/2,3,-",
          "country_local" => "(8 B) C/2,3,-",
          "city_local" => "C/2,3,-"
          ],
        "length"=>10,
        "unknowns_length"=>5,
        "cities"=>[
          ...
          "495"=>[
            "name"=>"Moscow",
            "name_local"=>"Москва",
            "local"=>false //cannot omit country/city code
          ],
          "39047"=>[
            "name"=>"Abaza",
            "name_local"=>"Абаза",
            "local"=>true, //can omit country/city code if local
          ],
          "499"=>"495" // alias
          ]
      ],
